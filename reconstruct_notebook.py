...
def create_notebook():
    ...
    cells.append({
        ...
        "source": [
            ...
            "            --save-results results/cb_{model}_{protocol}.json\n",
            "\n",
    ...
    cells.append({
        ...
        "source": [
            ...
            "            'Model': model_name,\n",
            "            'Protocol': protocol,\n",
            "            'Recall@10': data.get('Recall@10', data.get('recall', 0)),\n",
            "            'NDCG@10': data.get('NDCG@10', data.get('ndcg', 0)),\n",
            "            'AUC': data.get('AUC', data.get('auc', 0))\n",
            "        })\n",
