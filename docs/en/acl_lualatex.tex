...
% Title
% =========================
\title{\textbf{Heterogeneous Graph Learning for News Recommendation}\\
\large DS300.Q11 -- Final Project Report}

\author{
    \textbf{Authors:} Tang Nhat\textsuperscript{1,2,3}, Le Minh Nhut\textsuperscript{1,2,3}, Nguyen Hung Phat\textsuperscript{1,2,3}\\
