...
class SimGCL(nn.Module):
    ...
    Difference from LightGCL:
    - No SVD augmentation
    - Add uniform noise to embeddings for contrastive learning
    """
    ...
    def __init__(
        ...
        Args:
            ...
            eps: Noise magnitude for perturbation
            dropout: Dropout rate
            reg_weight: L2 regularization weight
            ssl_weight: Contrastive loss weight
            temp: Temperature for InfoNCE loss
        """
    ...
    def forward(self, adj_norm: torch.sparse.Tensor, 
        ...
        for layer in range(self.n_layers):
            ...
            # Add noise perturbation for contrastive learning
            if perturb:
                all_embeddings = self._add_noise(all_embeddings)
